    ...
    <div v-else>
      ...
      <div class="flex flex-wrap gap-2">
        <div
          ...
          :key="asset.symbol"
          class="bg-white border border-gray-200 rounded-xl shadow-sm p-5 w-full sm:w-1/3 md:w-1/4 lg:w-1/5"
        >
          ...
          <div class="space-y-1 text-sm">
            ...
            <div class="flex justify-between">
              ...
              <span class="font-medium text-amber-600">{{ asset.locked_amount }}</span>
            </div>
